...
abstract final class RequestsColors {
  ...
  static const Color requestConfirmation = Color(0xFF2F80ED);
  static const Color requestTuition = Color(0xFF27AE60);
  static const Color requestOther = Color(0xFF9B6A3D);
